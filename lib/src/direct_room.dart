...
@JsonSerializable()
@immutable
abstract class DirectRoom extends Equatable {
  /// Creates a [DirectRoom].
  const DirectRoom._({
    this.createdAt,
    required this.id,
    this.imageUrl,
  ...
  Map<String, dynamic> toJson() => _$DirectRoomToJson(this);
}

/// A utility class to enable better copyWith.
class _DirectRoom extends DirectRoom {
  const _DirectRoom({
    super.createdAt,
    required super.id,
    super.imageUrl,
